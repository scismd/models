...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'object_detection.protos.train_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  DESCRIPTOR._loaded_options = None
  _globals['_TRAINCONFIG'].fields_by_name['from_detection_checkpoint']._loaded_options = None
  _globals['_TRAINCONFIG'].fields_by_name['from_detection_checkpoint']._serialized_options = b'\030\001'
  _globals['_TRAINCONFIG'].fields_by_name['batch_queue_capacity']._loaded_options = None
  _globals['_TRAINCONFIG'].fields_by_name['batch_queue_capacity']._serialized_options = b'\030\001'
  _globals['_TRAINCONFIG'].fields_by_name['num_batch_queue_threads']._loaded_options = None
  _globals['_TRAINCONFIG'].fields_by_name['num_batch_queue_threads']._serialized_options = b'\030\001'
  _globals['_TRAINCONFIG'].fields_by_name['prefetch_queue_capacity']._loaded_options = None
  _globals['_TRAINCONFIG'].fields_by_name['prefetch_queue_capacity']._serialized_options = b'\030\001'
  _globals['_TRAINCONFIG'].fields_by_name['max_number_of_boxes']._loaded_options = None
  _globals['_TRAINCONFIG'].fields_by_name['max_number_of_boxes']._serialized_options = b'\030\001'
  _globals['_CHECKPOINTVERSION']._serialized_start=1353
  _globals['_CHECKPOINTVERSION']._serialized_end=1401
  _globals['_TRAINCONFIG']._serialized_start=150
  _globals['_TRAINCONFIG']._serialized_end=1351
