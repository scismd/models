...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_EVALCONFIG_SUPERCATEGORIESENTRY']._loaded_options = None
  _globals['_EVALCONFIG_SUPERCATEGORIESENTRY']._serialized_options = b'8\001'
  _globals['_EVALCONFIG'].fields_by_name['num_examples']._loaded_options = None
  _globals['_EVALCONFIG'].fields_by_name['num_examples']._serialized_options = b'\030\001'
  _globals['_EVALCONFIG'].fields_by_name['max_evals']._loaded_options = None
  _globals['_EVALCONFIG'].fields_by_name['max_evals']._serialized_options = b'\030\001'
  _globals['_COCOKEYPOINTMETRICS_KEYPOINTLABELTOSIGMASENTRY']._loaded_options = None
