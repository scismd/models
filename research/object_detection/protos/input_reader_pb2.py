...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_INPUTREADER'].fields_by_name['queue_capacity']._loaded_options = None
  _globals['_INPUTREADER'].fields_by_name['queue_capacity']._serialized_options = b'\030\001'
  _globals['_INPUTREADER'].fields_by_name['min_after_dequeue']._loaded_options = None
  _globals['_INPUTREADER'].fields_by_name['min_after_dequeue']._serialized_options = b'\030\001'
  _globals['_INPUTREADER'].fields_by_name['prefetch_size']._loaded_options = None
  _globals['_INPUTREADER'].fields_by_name['prefetch_size']._serialized_options = b'\030\001'
  _globals['_INPUTREADER'].fields_by_name['num_parallel_map_calls']._loaded_options = None
